...
<div class="buttons">
	...
	<?php if($model->status===CodeModel::STATUS_PREVIEW && !$model->hasErrors()): ?>
...
<?php if(!$model->hasErrors()): ?>
	<div class="feedback">
	<?php if($model->status===CodeModel::STATUS_SUCCESS): ?>
		<div class="success">
			<?php echo $model->successMessage(); ?>
		</div>
	<?php elseif($model->status===CodeModel::STATUS_ERROR): ?>
		<div class="error">
